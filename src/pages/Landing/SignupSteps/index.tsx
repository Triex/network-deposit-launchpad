      ...
      <StepsContainer>
        <ScrollAnimation animateIn="fadeInUp" animateOnce>
          <Step
            ...
            content={intl.formatMessage({
              defaultMessage:
                'The L16 upgrades will only be successful if validators understand the risks and responsibilities.',
            })}
          >
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOnce delay={300}>
          <Step
            ...
            content={intl.formatMessage({
              defaultMessage:
                "You'll need to run a L16 node to become a validator. Take a look at the checklist to prepare yourself and your equipment.",
            })}
          >
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOnce delay={150}>
          <Step
            ...
            content={intl.formatMessage({
              defaultMessage:
                "Once you're comfortable, you'll go through generating your keys and depositing your LYX.",
            })}
          >
